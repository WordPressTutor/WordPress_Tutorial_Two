...
<main class="wp-block-group alignfull"><!-- wp:cover {"url":"<?php echo esc_url(get_template_directory_uri()); ?>/images/banner.png","id":9384,"dimRatio":0,"focalPoint":{"x":0.48,"y":0.57},"minHeight":714,"minHeightUnit":"px","className":"main-banner-section position-relative"} -->
<div class="wp-block-cover main-banner-section position-relative" style="min-height:714px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-9384" alt="" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/banner.png" style="object-position:48% 57%" data-object-fit="cover" data-object-position="48% 57%"/><div class="wp-block-cover__inner-container"><!-- wp:columns -->
...
<!-- wp:search {"label":"Search","showLabel":false,"buttonText":"Search","buttonPosition":"button-inside","className":"banner-search-section"} /-->

<!-- wp:paragraph {"textColor":"white","className":"banner-last-text"} -->
<p class="banner-last-text has-white-color has-text-color"><?php echo esc_html__( 'Popular Search :- Car, Real Estate, Restaurant, Pets, Electronics', 'classified-listings' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
